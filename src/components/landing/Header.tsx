  ...
  return (
    <header className="max-w-[1920px] mx-auto bg-background px-6 py-4 fixed top-0 left-0 right-0 z-50">
      <div className="max-w-[80%] mx-auto flex items-center justify-between">
        {/* Logo */}
        <p className="text-white font-extrabold text-2xl tracking-wide font-montserrat">
          DUBIO.AI
        </p>
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="bg-[#7C3AED] text-white px-12 py-3 rounded-full font-bold hover:bg-[#6D28D9] transition-colors">
            Join Waitlist
          </button>
        </div>
      </div>
